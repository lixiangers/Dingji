package com.lixiangers.dingji.view.PullRefreshListView;
...
import static com.lixiangers.dingji.view.PullRefreshListView.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     * 判断滑动到底部加载是否可用
     */
    private boolean mScrollRefreshEnabled = false;
    /**
     * 是否截断touch事件
     */
            ...
            case MotionEvent.ACTION_UP:
                if (mIsHandledTouchEvent) {
                    ...
                    if (isReadyForPullDown()) {
                        // 调用刷新
                        if (mPullDownRefreshEnabled && (mPullDownState == State.RELEASE_TO_REFRESH)) {
                            startRefreshing();
                            handled = true;
                        }
                        resetHeaderLayout();
    ...
    @Override
    public void setPullDownRefreshEnabled(boolean pullRefreshEnabled) {
        mPullDownRefreshEnabled = pullRefreshEnabled;
    }

    @Override
    public void setPullUpRefreshEnabled(boolean pullLoadEnabled) {
        mPullUpRefreshEnabled = pullLoadEnabled;
    }

    @Override
    public void setScrollRefreshEnabled(boolean scrollLoadEnabled) {
        mScrollRefreshEnabled = scrollLoadEnabled;
    }

    @Override
    public boolean isPullRefreshEnabled() {
        return mPullDownRefreshEnabled && (null != mHeaderLayout);
    }

    @Override
    public boolean isPullLoadEnabled() {
        return mPullUpRefreshEnabled && (null != mFooterLayout);
    }

    @Override
    public boolean isScrollLoadEnabled() {
        return mScrollRefreshEnabled;
    }
