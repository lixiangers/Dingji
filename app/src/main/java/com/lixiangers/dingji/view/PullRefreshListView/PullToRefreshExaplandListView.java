 ...
 */
public class PullToRefreshExaplandListView extends PullToRefreshBase<ExpandableListView> implements OnScrollListener {
     ...
     */
    public PullToRefreshExaplandListView(Context context) {
        this(context, null);
    }
     ...
     * @param attrs   attrs
     */
    public PullToRefreshExaplandListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setScrollRefreshEnabled(boolean scrollLoadEnabled) {
        super.setScrollRefreshEnabled(scrollLoadEnabled);
