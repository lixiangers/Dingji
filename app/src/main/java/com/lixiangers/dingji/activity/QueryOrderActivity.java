    ...
    private void initPullListView() {
        ...
        orderPullListView.getRefreshableView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                boolean needChange = isAdmin && (adapter.getItem(i).getStatus() != OrderStatus.SUCCESS.getIndex());
                intent.putExtra(Constant.IS_NEED_CHANGE_ORDER, needChange);
        ...
        orderPullListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                if (isAdmin)
                    queryOrder(getTextFrom(keywordEditView));
                else
                    loadOrder();
            }
        });
