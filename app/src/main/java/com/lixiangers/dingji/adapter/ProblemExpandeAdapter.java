...
public class ProblemExpandeAdapter extends BaseExpandableListAdapter {
    ...
    public void setOnByGoodsListener(ProblemExpandeAdapter.onByGoodsListener onByGoodsListener) {
        this.onByGoodsListener = onByGoodsListener;
    }

    public ProblemExpandeAdapter(Context ctx, List<GoodsCategory> list) {
        context = ctx;
